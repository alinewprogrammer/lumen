    ...
    <div className="">
      ...
      <main className="flex-1 flex flex-col items-center px-4 py-16 sm:px-6 text-center gap-20">
        <div className="max-w-4xl space-y-8 relative">
          {/* Background gradient */}
          <div className="absolute inset-0 -z-10 bg-gradient-to-br from-blue-50 via-teal-50 to-cyan-50 dark:from-blue-950/20 dark:via-teal-950/20 dark:to-cyan-950/20 rounded-3xl blur-3xl scale-150 opacity-60"></div>

          <div className="max-w-4xl space-y-8 relative" >
            <h1 className="text-5xl sm:text-7xl font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-blue-700 via-teal-600 to-cyan-500 dark:from-blue-400 dark:via-teal-400 dark:to-cyan-400">
              Connect instantly.
              <br />
          ...
          <div className="flex flex-col sm:flow-row justify-center items-center gap-4 pt-6">
            <SignedOut>
              <SignInButton mode="modal">
                <Button size={'lg'} className="text-lg px-8 py-6 h-auto">Start Chatting Free</Button>
              </SignInButton>
            </SignedOut>
          </div>
          ...
          <div className="w-full max-w-6xl">
            ...
            <div className="w-full flex items-center justify-center mb-16">
              ...
              <div className="px-6">
                <div className="w-2 h-2 rounded-full bg-teal-600/60"></div>
              </div>
              <div className="flex-1 h-px bg-gradient-to-r from-transparent via-border to-transparent"></div>
            </div>
          ...
          <div className="w-full max-w-4xl">
              <div className="rounded-2xl border bg-gradient-to-br from-teal-500/5 to-cyan-500/10 p-12 text-center">
